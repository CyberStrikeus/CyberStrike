...
- [ ] Verify ID.AM-03 ID.AM-03 outcome is achieved
- [ ] Review documentation and evidence for ID.AM-03
- [ ] Assess organizational maturity for IDENTIFY function
- [ ] Map to SP 800-53 controls that satisfy ID.AM-03

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for ID.AM-03.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that ID.AM-03 outcome is met
...
Achieve the ID.AM-03 ID.AM-03 outcome:
...
| ------- | -------- | ------ |
| ID.AM-03 ID.AM-03 outcome not achieved | Medium | IDENTIFY Function Gap |
