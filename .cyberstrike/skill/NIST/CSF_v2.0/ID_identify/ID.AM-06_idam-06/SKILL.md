...
- [ ] Verify ID.AM-06 ID.AM-06 outcome is achieved
- [ ] Review documentation and evidence for ID.AM-06
- [ ] Assess organizational maturity for IDENTIFY function
- [ ] Map to SP 800-53 controls that satisfy ID.AM-06

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for ID.AM-06.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that ID.AM-06 outcome is met
...
Achieve the ID.AM-06 ID.AM-06 outcome:
...
| ------- | -------- | ------ |
| ID.AM-06 ID.AM-06 outcome not achieved | Medium | IDENTIFY Function Gap |
