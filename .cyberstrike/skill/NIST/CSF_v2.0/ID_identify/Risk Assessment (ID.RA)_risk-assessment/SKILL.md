---
name: "Risk Assessment (ID.RA)_risk-assessment"
...
- [ ] Verify Risk Assessment (ID.RA) Risk Assessment outcome is achieved
- [ ] Review documentation and evidence for Risk Assessment (ID.RA)
...
Determine the organization's current and target CSF profile tier for Risk Assessment (ID.RA).

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that Risk Assessment (ID.RA) outcome is met
...
Achieve the Risk Assessment (ID.RA) Risk Assessment outcome:
...
| ------- | -------- | ------ |
| Risk Assessment (ID.RA) Risk Assessment outcome not achieved | Medium | IDENTIFY Function Gap |
