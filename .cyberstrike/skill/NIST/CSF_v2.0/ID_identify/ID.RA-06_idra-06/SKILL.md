...
- [ ] Verify ID.RA-06 ID.RA-06 outcome is achieved
- [ ] Review documentation and evidence for ID.RA-06
- [ ] Assess organizational maturity for IDENTIFY function
- [ ] Map to SP 800-53 controls that satisfy ID.RA-06

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for ID.RA-06.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that ID.RA-06 outcome is met
...
Achieve the ID.RA-06 ID.RA-06 outcome:
...
| ------- | -------- | ------ |
| ID.RA-06 ID.RA-06 outcome not achieved | Medium | IDENTIFY Function Gap |
