...
- [ ] Verify ID.IM-01 ID.IM-01 outcome is achieved
- [ ] Review documentation and evidence for ID.IM-01
- [ ] Assess organizational maturity for IDENTIFY function
- [ ] Map to SP 800-53 controls that satisfy ID.IM-01

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for ID.IM-01.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that ID.IM-01 outcome is met
...
Achieve the ID.IM-01 ID.IM-01 outcome:
...
| ------- | -------- | ------ |
| ID.IM-01 ID.IM-01 outcome not achieved | Medium | IDENTIFY Function Gap |
