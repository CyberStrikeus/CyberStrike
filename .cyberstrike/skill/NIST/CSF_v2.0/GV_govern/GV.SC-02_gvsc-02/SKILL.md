---
name: "GV.SC-02_gvsc-02"
description: "Cybersecurity roles and responsibilities for suppliers, customers, and partners are established, communicated, and coordinated internally and external"
...
- [ ] Verify GV.SC-02 GV.SC-02 outcome is achieved
- [ ] Review documentation and evidence for GV.SC-02
- [ ] Assess organizational maturity for GOVERN function
- [ ] Map to SP 800-53 controls that satisfy GV.SC-02

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for GV.SC-02.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that GV.SC-02 outcome is met
...
Achieve the GV.SC-02 GV.SC-02 outcome:
...
| ------- | -------- | ------ |
| GV.SC-02 GV.SC-02 outcome not achieved | Medium | GOVERN Function Gap |
