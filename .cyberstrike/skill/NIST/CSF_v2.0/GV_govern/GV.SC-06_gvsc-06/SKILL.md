...
- [ ] Verify GV.SC-06 GV.SC-06 outcome is achieved
- [ ] Review documentation and evidence for GV.SC-06
- [ ] Assess organizational maturity for GOVERN function
- [ ] Map to SP 800-53 controls that satisfy GV.SC-06

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for GV.SC-06.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that GV.SC-06 outcome is met
...
Achieve the GV.SC-06 GV.SC-06 outcome:
...
| ------- | -------- | ------ |
| GV.SC-06 GV.SC-06 outcome not achieved | Medium | GOVERN Function Gap |
