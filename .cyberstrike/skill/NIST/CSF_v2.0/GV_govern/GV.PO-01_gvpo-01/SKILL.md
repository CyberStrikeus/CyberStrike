---
name: "GV.PO-01_gvpo-01"
description: "Policy for managing cybersecurity risks is established based on organizational context, cybersecurity strategy, and priorities and is communicated and"
...
- [ ] Verify GV.PO-01 GV.PO-01 outcome is achieved
- [ ] Review documentation and evidence for GV.PO-01
- [ ] Assess organizational maturity for GOVERN function
- [ ] Map to SP 800-53 controls that satisfy GV.PO-01

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for GV.PO-01.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that GV.PO-01 outcome is met
...
Achieve the GV.PO-01 GV.PO-01 outcome:
...
| ------- | -------- | ------ |
| GV.PO-01 GV.PO-01 outcome not achieved | Medium | GOVERN Function Gap |
