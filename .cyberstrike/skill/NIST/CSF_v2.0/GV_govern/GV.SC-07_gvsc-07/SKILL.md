---
name: "GV.SC-07_gvsc-07"
description: "The risks posed by a supplier, their products and services, and other third parties are understood, recorded, prioritized, assessed, responded to, and"
...
- [ ] Verify GV.SC-07 GV.SC-07 outcome is achieved
- [ ] Review documentation and evidence for GV.SC-07
- [ ] Assess organizational maturity for GOVERN function
- [ ] Map to SP 800-53 controls that satisfy GV.SC-07

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for GV.SC-07.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that GV.SC-07 outcome is met
...
Achieve the GV.SC-07 GV.SC-07 outcome:
...
| ------- | -------- | ------ |
| GV.SC-07 GV.SC-07 outcome not achieved | Medium | GOVERN Function Gap |
