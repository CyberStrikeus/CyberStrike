...
- [ ] Verify GV.RR-03 GV.RR-03 outcome is achieved
- [ ] Review documentation and evidence for GV.RR-03
- [ ] Assess organizational maturity for GOVERN function
- [ ] Map to SP 800-53 controls that satisfy GV.RR-03

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for GV.RR-03.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that GV.RR-03 outcome is met
...
Achieve the GV.RR-03 GV.RR-03 outcome:
...
| ------- | -------- | ------ |
| GV.RR-03 GV.RR-03 outcome not achieved | Medium | GOVERN Function Gap |
