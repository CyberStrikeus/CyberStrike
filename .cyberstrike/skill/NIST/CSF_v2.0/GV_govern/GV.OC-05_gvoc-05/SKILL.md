...
- [ ] Verify GV.OC-05 GV.OC-05 outcome is achieved
- [ ] Review documentation and evidence for GV.OC-05
- [ ] Assess organizational maturity for GOVERN function
- [ ] Map to SP 800-53 controls that satisfy GV.OC-05

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for GV.OC-05.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that GV.OC-05 outcome is met
...
Achieve the GV.OC-05 GV.OC-05 outcome:
...
| ------- | -------- | ------ |
| GV.OC-05 GV.OC-05 outcome not achieved | Medium | GOVERN Function Gap |
