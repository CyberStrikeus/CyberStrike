...
- [ ] Verify Risk Management Strategy (GV.RM) Risk Management Strategy outcome is achieved
- [ ] Review documentation and evidence for Risk Management Strategy (GV.RM)
