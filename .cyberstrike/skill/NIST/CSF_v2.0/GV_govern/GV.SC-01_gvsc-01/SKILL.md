---
name: "GV.SC-01_gvsc-01"
description: "A cybersecurity supply chain risk management program, strategy, objectives, policies, and processes are established and agreed to by organizational st"
...
- [ ] Verify GV.SC-01 GV.SC-01 outcome is achieved
- [ ] Review documentation and evidence for GV.SC-01
- [ ] Assess organizational maturity for GOVERN function
- [ ] Map to SP 800-53 controls that satisfy GV.SC-01

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for GV.SC-01.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that GV.SC-01 outcome is met
...
Achieve the GV.SC-01 GV.SC-01 outcome:
...
| ------- | -------- | ------ |
| GV.SC-01 GV.SC-01 outcome not achieved | Medium | GOVERN Function Gap |
