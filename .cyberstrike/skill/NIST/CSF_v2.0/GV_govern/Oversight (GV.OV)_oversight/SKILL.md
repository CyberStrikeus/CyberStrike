---
name: "Oversight (GV.OV)_oversight"
description: "Results of organization-wide cybersecurity risk management activities and performance are used to inform, improve, and adjust the risk management stra"
...
- [ ] Verify Oversight (GV.OV) Oversight outcome is achieved
- [ ] Review documentation and evidence for Oversight (GV.OV)
...
Determine the organization's current and target CSF profile tier for Oversight (GV.OV).

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that Oversight (GV.OV) outcome is met
...
Achieve the Oversight (GV.OV) Oversight outcome:
...
| ------- | -------- | ------ |
| Oversight (GV.OV) Oversight outcome not achieved | Medium | GOVERN Function Gap |
