---
name: "GV.SC-05_gvsc-05"
description: "Requirements to address cybersecurity risks in supply chains are established, prioritized, and integrated into contracts and other types of agreements"
...
- [ ] Verify GV.SC-05 GV.SC-05 outcome is achieved
- [ ] Review documentation and evidence for GV.SC-05
- [ ] Assess organizational maturity for GOVERN function
- [ ] Map to SP 800-53 controls that satisfy GV.SC-05

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for GV.SC-05.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that GV.SC-05 outcome is met
...
Achieve the GV.SC-05 GV.SC-05 outcome:
...
| ------- | -------- | ------ |
| GV.SC-05 GV.SC-05 outcome not achieved | Medium | GOVERN Function Gap |
