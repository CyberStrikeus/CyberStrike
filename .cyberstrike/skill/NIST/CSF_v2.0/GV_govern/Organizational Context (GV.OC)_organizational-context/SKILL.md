---
name: "Organizational Context (GV.OC)_organizational-context"
description: "The circumstances - mission, stakeholder expectations, dependencies, and legal, regulatory, and contractual requirements - surrounding the organizatio"
...
# Organizational Context (GV.OC) Organizational Context
...
- [ ] Verify Organizational Context (GV.OC) Organizational Context outcome is achieved
- [ ] Review documentation and evidence for Organizational Context (GV.OC)
...
Determine the organization's current and target CSF profile tier for Organizational Context (GV.OC).

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that Organizational Context (GV.OC) outcome is met
...
Achieve the Organizational Context (GV.OC) Organizational Context outcome:
...
| ------- | -------- | ------ |
| Organizational Context (GV.OC) Organizational Context outcome not achieved | Medium | GOVERN Function Gap |
