...
- [ ] Verify GV.RM-07 GV.RM-07 outcome is achieved
- [ ] Review documentation and evidence for GV.RM-07
- [ ] Assess organizational maturity for GOVERN function
- [ ] Map to SP 800-53 controls that satisfy GV.RM-07

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for GV.RM-07.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that GV.RM-07 outcome is met
...
Achieve the GV.RM-07 GV.RM-07 outcome:
...
| ------- | -------- | ------ |
| GV.RM-07 GV.RM-07 outcome not achieved | Medium | GOVERN Function Gap |
