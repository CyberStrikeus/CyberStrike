...
- [ ] Verify PR.MA-01 PR.MA-01 outcome is achieved
- [ ] Review documentation and evidence for PR.MA-01
- [ ] Assess organizational maturity for PROTECT function
- [ ] Map to SP 800-53 controls that satisfy PR.MA-01

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for PR.MA-01.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that PR.MA-01 outcome is met
...
Achieve the PR.MA-01 PR.MA-01 outcome:
...
| ------- | -------- | ------ |
| PR.MA-01 PR.MA-01 outcome not achieved | High | PROTECT Function Gap |
