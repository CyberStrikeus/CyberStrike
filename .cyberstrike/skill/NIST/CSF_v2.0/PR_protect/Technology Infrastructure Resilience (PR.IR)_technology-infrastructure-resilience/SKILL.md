---
name: "Technology Infrastructure Resilience (PR.IR)_technology-infrastructure-resilience"
description: "Security architectures are managed with the organization's risk strategy to protect asset confidentiality, integrity, and availability, and organizati"
...
# Technology Infrastructure Resilience (PR.IR) Technology Infrastructure Resilience
...
- [ ] Verify Technology Infrastructure Resilience (PR.IR) Technology Infrastructure Resilience outcome is achieved
- [ ] Review documentation and evidence for Technology Infrastructure Resilience (PR.IR)
...
Determine the organization's current and target CSF profile tier for Technology Infrastructure Resilience (PR.IR).

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that Technology Infrastructure Resilience (PR.IR) outcome is met
...
Achieve the Technology Infrastructure Resilience (PR.IR) Technology Infrastructure Resilience outcome:
