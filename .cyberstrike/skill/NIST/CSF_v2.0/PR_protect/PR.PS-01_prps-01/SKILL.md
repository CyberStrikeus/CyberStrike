...
- [ ] Verify PR.PS-01 PR.PS-01 outcome is achieved
- [ ] Review documentation and evidence for PR.PS-01
- [ ] Assess organizational maturity for PROTECT function
- [ ] Map to SP 800-53 controls that satisfy PR.PS-01

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for PR.PS-01.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that PR.PS-01 outcome is met
...
Achieve the PR.PS-01 PR.PS-01 outcome:
...
| ------- | -------- | ------ |
| PR.PS-01 PR.PS-01 outcome not achieved | High | PROTECT Function Gap |
