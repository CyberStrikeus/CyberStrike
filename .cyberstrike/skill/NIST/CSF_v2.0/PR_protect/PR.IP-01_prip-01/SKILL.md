---
name: "PR.IP-01_prip-01"
description: "A baseline configuration of information technology/industrial control systems is created and maintained incorporating security principles (e.g."
...
- [ ] Verify PR.IP-01 PR.IP-01 outcome is achieved
- [ ] Review documentation and evidence for PR.IP-01
- [ ] Assess organizational maturity for PROTECT function
- [ ] Map to SP 800-53 controls that satisfy PR.IP-01

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for PR.IP-01.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that PR.IP-01 outcome is met
...
Achieve the PR.IP-01 PR.IP-01 outcome:
...
| ------- | -------- | ------ |
| PR.IP-01 PR.IP-01 outcome not achieved | High | PROTECT Function Gap |
