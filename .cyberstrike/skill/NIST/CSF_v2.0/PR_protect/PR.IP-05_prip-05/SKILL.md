...
- [ ] Verify PR.IP-05 PR.IP-05 outcome is achieved
- [ ] Review documentation and evidence for PR.IP-05
- [ ] Assess organizational maturity for PROTECT function
- [ ] Map to SP 800-53 controls that satisfy PR.IP-05

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for PR.IP-05.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that PR.IP-05 outcome is met
...
Achieve the PR.IP-05 PR.IP-05 outcome:
...
| ------- | -------- | ------ |
| PR.IP-05 PR.IP-05 outcome not achieved | High | PROTECT Function Gap |
