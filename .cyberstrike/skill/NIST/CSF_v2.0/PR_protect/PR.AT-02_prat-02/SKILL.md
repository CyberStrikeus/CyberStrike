---
name: "PR.AT-02_prat-02"
description: "Individuals in specialized roles are provided with awareness and training so that they possess the knowledge and skills to perform relevant tasks with"
...
> **Subcategory of:** Awareness and Training (PR.AT)
...
- [ ] Verify PR.AT-02 PR.AT-02 outcome is achieved
- [ ] Review documentation and evidence for PR.AT-02
- [ ] Assess organizational maturity for PROTECT function
- [ ] Map to SP 800-53 controls that satisfy PR.AT-02

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for PR.AT-02.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that PR.AT-02 outcome is met
...
Achieve the PR.AT-02 PR.AT-02 outcome:
...
| ------- | -------- | ------ |
| PR.AT-02 PR.AT-02 outcome not achieved | High | PROTECT Function Gap |
