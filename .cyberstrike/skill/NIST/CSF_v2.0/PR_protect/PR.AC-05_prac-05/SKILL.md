...
- [ ] Verify PR.AC-05 PR.AC-05 outcome is achieved
- [ ] Review documentation and evidence for PR.AC-05
- [ ] Assess organizational maturity for PROTECT function
- [ ] Map to SP 800-53 controls that satisfy PR.AC-05

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for PR.AC-05.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that PR.AC-05 outcome is met
...
Achieve the PR.AC-05 PR.AC-05 outcome:
...
| ------- | -------- | ------ |
| PR.AC-05 PR.AC-05 outcome not achieved | High | PROTECT Function Gap |
