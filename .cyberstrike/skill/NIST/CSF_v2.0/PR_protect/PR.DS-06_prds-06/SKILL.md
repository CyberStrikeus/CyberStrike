...
- [ ] Verify PR.DS-06 PR.DS-06 outcome is achieved
- [ ] Review documentation and evidence for PR.DS-06
- [ ] Assess organizational maturity for PROTECT function
- [ ] Map to SP 800-53 controls that satisfy PR.DS-06

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for PR.DS-06.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that PR.DS-06 outcome is met
...
Achieve the PR.DS-06 PR.DS-06 outcome:
...
| ------- | -------- | ------ |
| PR.DS-06 PR.DS-06 outcome not achieved | High | PROTECT Function Gap |
