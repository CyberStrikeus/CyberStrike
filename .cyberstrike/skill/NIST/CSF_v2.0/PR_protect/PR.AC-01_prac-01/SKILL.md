...
- [ ] Verify PR.AC-01 PR.AC-01 outcome is achieved
- [ ] Review documentation and evidence for PR.AC-01
- [ ] Assess organizational maturity for PROTECT function
- [ ] Map to SP 800-53 controls that satisfy PR.AC-01

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for PR.AC-01.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that PR.AC-01 outcome is met
...
Achieve the PR.AC-01 PR.AC-01 outcome:
...
| ------- | -------- | ------ |
| PR.AC-01 PR.AC-01 outcome not achieved | High | PROTECT Function Gap |
