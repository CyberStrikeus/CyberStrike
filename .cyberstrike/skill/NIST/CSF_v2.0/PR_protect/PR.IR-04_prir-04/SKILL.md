...
- [ ] Verify PR.IR-04 PR.IR-04 outcome is achieved
- [ ] Review documentation and evidence for PR.IR-04
- [ ] Assess organizational maturity for PROTECT function
- [ ] Map to SP 800-53 controls that satisfy PR.IR-04

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for PR.IR-04.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that PR.IR-04 outcome is met
...
Achieve the PR.IR-04 PR.IR-04 outcome:
...
| ------- | -------- | ------ |
| PR.IR-04 PR.IR-04 outcome not achieved | High | PROTECT Function Gap |
