...
- [ ] Verify DE.AE-03 DE.AE-03 outcome is achieved
- [ ] Review documentation and evidence for DE.AE-03
- [ ] Assess organizational maturity for DETECT function
- [ ] Map to SP 800-53 controls that satisfy DE.AE-03

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for DE.AE-03.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that DE.AE-03 outcome is met
...
Achieve the DE.AE-03 DE.AE-03 outcome:
...
| ------- | -------- | ------ |
| DE.AE-03 DE.AE-03 outcome not achieved | High | DETECT Function Gap |
