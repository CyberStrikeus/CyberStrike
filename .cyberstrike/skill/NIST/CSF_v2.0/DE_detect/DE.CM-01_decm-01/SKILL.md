...
- [ ] Verify DE.CM-01 DE.CM-01 outcome is achieved
- [ ] Review documentation and evidence for DE.CM-01
- [ ] Assess organizational maturity for DETECT function
- [ ] Map to SP 800-53 controls that satisfy DE.CM-01

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for DE.CM-01.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that DE.CM-01 outcome is met
...
Achieve the DE.CM-01 DE.CM-01 outcome:
...
| ------- | -------- | ------ |
| DE.CM-01 DE.CM-01 outcome not achieved | High | DETECT Function Gap |
