...
- [ ] Verify DE.DP-05 DE.DP-05 outcome is achieved
- [ ] Review documentation and evidence for DE.DP-05
- [ ] Assess organizational maturity for DETECT function
- [ ] Map to SP 800-53 controls that satisfy DE.DP-05

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for DE.DP-05.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that DE.DP-05 outcome is met
...
Achieve the DE.DP-05 DE.DP-05 outcome:
...
| ------- | -------- | ------ |
| DE.DP-05 DE.DP-05 outcome not achieved | High | DETECT Function Gap |
