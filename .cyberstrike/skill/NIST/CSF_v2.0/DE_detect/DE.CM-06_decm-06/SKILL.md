...
- [ ] Verify DE.CM-06 DE.CM-06 outcome is achieved
- [ ] Review documentation and evidence for DE.CM-06
- [ ] Assess organizational maturity for DETECT function
- [ ] Map to SP 800-53 controls that satisfy DE.CM-06

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for DE.CM-06.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that DE.CM-06 outcome is met
...
Achieve the DE.CM-06 DE.CM-06 outcome:
