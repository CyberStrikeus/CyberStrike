...
> **Subcategory of:** Incident Recovery Communication (RC.CO)
...
- [ ] Verify RC.CO-02 RC.CO-02 outcome is achieved
- [ ] Review documentation and evidence for RC.CO-02
- [ ] Assess organizational maturity for RECOVER function
- [ ] Map to SP 800-53 controls that satisfy RC.CO-02

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for RC.CO-02.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that RC.CO-02 outcome is met
...
Achieve the RC.CO-02 RC.CO-02 outcome:
...
| ------- | -------- | ------ |
| RC.CO-02 RC.CO-02 outcome not achieved | Medium | RECOVER Function Gap |
