...
- [ ] Verify RC.RP-06 RC.RP-06 outcome is achieved
- [ ] Review documentation and evidence for RC.RP-06
- [ ] Assess organizational maturity for RECOVER function
- [ ] Map to SP 800-53 controls that satisfy RC.RP-06

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for RC.RP-06.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that RC.RP-06 outcome is met
...
Achieve the RC.RP-06 RC.RP-06 outcome:
...
| ------- | -------- | ------ |
| RC.RP-06 RC.RP-06 outcome not achieved | Medium | RECOVER Function Gap |
