...
- [ ] Verify RC.CO-01 RC.CO-01 outcome is achieved
- [ ] Review documentation and evidence for RC.CO-01
- [ ] Assess organizational maturity for RECOVER function
- [ ] Map to SP 800-53 controls that satisfy RC.CO-01

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for RC.CO-01.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that RC.CO-01 outcome is met
...
Achieve the RC.CO-01 RC.CO-01 outcome:
...
| ------- | -------- | ------ |
| RC.CO-01 RC.CO-01 outcome not achieved | Medium | RECOVER Function Gap |
