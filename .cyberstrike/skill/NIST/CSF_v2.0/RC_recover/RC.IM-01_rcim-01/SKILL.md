...
- [ ] Verify RC.IM-01 RC.IM-01 outcome is achieved
- [ ] Review documentation and evidence for RC.IM-01
- [ ] Assess organizational maturity for RECOVER function
- [ ] Map to SP 800-53 controls that satisfy RC.IM-01

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for RC.IM-01.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that RC.IM-01 outcome is met
...
Achieve the RC.IM-01 RC.IM-01 outcome:
...
| ------- | -------- | ------ |
| RC.IM-01 RC.IM-01 outcome not achieved | Medium | RECOVER Function Gap |
