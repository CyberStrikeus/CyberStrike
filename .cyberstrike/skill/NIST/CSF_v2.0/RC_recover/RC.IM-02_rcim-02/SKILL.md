...
> **Subcategory of:** Improvements (RC.IM)
...
- [ ] Verify RC.IM-02 RC.IM-02 outcome is achieved
- [ ] Review documentation and evidence for RC.IM-02
- [ ] Assess organizational maturity for RECOVER function
- [ ] Map to SP 800-53 controls that satisfy RC.IM-02

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for RC.IM-02.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that RC.IM-02 outcome is met
...
Achieve the RC.IM-02 RC.IM-02 outcome:
...
| ------- | -------- | ------ |
| RC.IM-02 RC.IM-02 outcome not achieved | Medium | RECOVER Function Gap |
