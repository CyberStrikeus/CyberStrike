---
name: "Incident Management (RS.MA)_incident-management"
...
# Incident Management (RS.MA) Incident Management
...
- [ ] Verify Incident Management (RS.MA) Incident Management outcome is achieved
- [ ] Review documentation and evidence for Incident Management (RS.MA)
...
Determine the organization's current and target CSF profile tier for Incident Management (RS.MA).

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that Incident Management (RS.MA) outcome is met
...
Achieve the Incident Management (RS.MA) Incident Management outcome:
...
| ------- | -------- | ------ |
| Incident Management (RS.MA) Incident Management outcome not achieved | Medium | RESPOND Function Gap |
