---
name: "Response Planning (RS.RP)_response-planning"
...
# Response Planning (RS.RP) Response Planning
...
- [ ] Verify Response Planning (RS.RP) Response Planning outcome is achieved
- [ ] Review documentation and evidence for Response Planning (RS.RP)
...
Determine the organization's current and target CSF profile tier for Response Planning (RS.RP).

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that Response Planning (RS.RP) outcome is met
...
Achieve the Response Planning (RS.RP) Response Planning outcome:

Implement controls that satisfy the Response Planning outcome per NIST CSF v2.0.

## Risk Assessment

| Finding | Severity | Impact |
| ------- | -------- | ------ |
| Response Planning (RS.RP) Response Planning outcome not achieved | Medium | RESPOND Function Gap |
