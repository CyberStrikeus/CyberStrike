...
- [ ] Verify RS.AN-02 RS.AN-02 outcome is achieved
- [ ] Review documentation and evidence for RS.AN-02
- [ ] Assess organizational maturity for RESPOND function
- [ ] Map to SP 800-53 controls that satisfy RS.AN-02

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for RS.AN-02.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that RS.AN-02 outcome is met
...
Achieve the RS.AN-02 RS.AN-02 outcome:
...
| ------- | -------- | ------ |
| RS.AN-02 RS.AN-02 outcome not achieved | Medium | RESPOND Function Gap |
