---
name: "RS.AN-05_rsan-05"
description: "Processes are established to receive, analyze and respond to vulnerabilities disclosed to the organization from internal and external sources (e.g."
...
> **Subcategory of:** Incident Analysis (RS.AN)
...
- [ ] Verify RS.AN-05 RS.AN-05 outcome is achieved
- [ ] Review documentation and evidence for RS.AN-05
- [ ] Assess organizational maturity for RESPOND function
- [ ] Map to SP 800-53 controls that satisfy RS.AN-05

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for RS.AN-05.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that RS.AN-05 outcome is met
...
Achieve the RS.AN-05 RS.AN-05 outcome:
...
| ------- | -------- | ------ |
| RS.AN-05 RS.AN-05 outcome not achieved | Medium | RESPOND Function Gap |
