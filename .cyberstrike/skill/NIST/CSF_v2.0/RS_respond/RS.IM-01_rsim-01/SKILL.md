...
> **Subcategory of:** Improvements (RS.IM)
...
- [ ] Verify RS.IM-01 RS.IM-01 outcome is achieved
- [ ] Review documentation and evidence for RS.IM-01
- [ ] Assess organizational maturity for RESPOND function
- [ ] Map to SP 800-53 controls that satisfy RS.IM-01

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for RS.IM-01.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that RS.IM-01 outcome is met
...
Achieve the RS.IM-01 RS.IM-01 outcome:
...
| ------- | -------- | ------ |
| RS.IM-01 RS.IM-01 outcome not achieved | Medium | RESPOND Function Gap |
