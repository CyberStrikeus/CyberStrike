...
- [ ] Verify RS.AN-08 RS.AN-08 outcome is achieved
- [ ] Review documentation and evidence for RS.AN-08
- [ ] Assess organizational maturity for RESPOND function
- [ ] Map to SP 800-53 controls that satisfy RS.AN-08

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for RS.AN-08.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that RS.AN-08 outcome is met
...
Achieve the RS.AN-08 RS.AN-08 outcome:
...
| ------- | -------- | ------ |
| RS.AN-08 RS.AN-08 outcome not achieved | Medium | RESPOND Function Gap |
