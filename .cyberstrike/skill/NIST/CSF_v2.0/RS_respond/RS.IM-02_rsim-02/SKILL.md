...
- [ ] Verify RS.IM-02 RS.IM-02 outcome is achieved
- [ ] Review documentation and evidence for RS.IM-02
- [ ] Assess organizational maturity for RESPOND function
- [ ] Map to SP 800-53 controls that satisfy RS.IM-02

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for RS.IM-02.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that RS.IM-02 outcome is met
...
Achieve the RS.IM-02 RS.IM-02 outcome:
...
| ------- | -------- | ------ |
| RS.IM-02 RS.IM-02 outcome not achieved | Medium | RESPOND Function Gap |
