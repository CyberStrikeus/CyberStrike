---
name: "Incident Mitigation (RS.MI)_incident-mitigation"
...
# Incident Mitigation (RS.MI) Incident Mitigation
...
- [ ] Verify Incident Mitigation (RS.MI) Incident Mitigation outcome is achieved
- [ ] Review documentation and evidence for Incident Mitigation (RS.MI)
...
Determine the organization's current and target CSF profile tier for Incident Mitigation (RS.MI).

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that Incident Mitigation (RS.MI) outcome is met
...
Achieve the Incident Mitigation (RS.MI) Incident Mitigation outcome:
...
| ------- | -------- | ------ |
| Incident Mitigation (RS.MI) Incident Mitigation outcome not achieved | Medium | RESPOND Function Gap |
