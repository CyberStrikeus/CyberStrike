...
- [ ] Verify RS.MA-02 RS.MA-02 outcome is achieved
- [ ] Review documentation and evidence for RS.MA-02
- [ ] Assess organizational maturity for RESPOND function
- [ ] Map to SP 800-53 controls that satisfy RS.MA-02

## How to Test

### Step 1: Identify Current Profile

Determine the organization's current and target CSF profile tier for RS.MA-02.

### Step 2: Assess Outcome Achievement

```
# Review organizational policies and procedures
# Check for evidence that RS.MA-02 outcome is met
...
Achieve the RS.MA-02 RS.MA-02 outcome:
...
| ------- | -------- | ------ |
| RS.MA-02 RS.MA-02 outcome not achieved | Medium | RESPOND Function Gap |
