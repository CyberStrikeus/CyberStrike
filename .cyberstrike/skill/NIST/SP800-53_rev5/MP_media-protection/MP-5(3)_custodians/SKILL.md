...
- [ ] Verify MP-5(3) Custodians is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for MP-5(3)
...
Examine the System Security Plan (SSP) and related artifacts for MP-5(3) implementation details. Verify the organization has documented how this control is satisfied.
...
| ------- | -------- | ------ |
| MP-5(3) Custodians not implemented | Medium | Media Protection |
| MP-5(3) partially implemented | Low | Incomplete Media Protection |
...
- [NIST SP 800-53 Rev 5 - MP-5(3)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=mp-5.3)
