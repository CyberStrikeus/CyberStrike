---
name: "AC-16(3)_maintenance-of-attribute-associations-by-system"
description: "Maintain the association and integrity of [organization-defined] to [organization-defined]."
...
- [ ] Verify AC-16(3) Maintenance of Attribute Associations by System is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for AC-16(3)
...
Examine the System Security Plan (SSP) and related artifacts for AC-16(3) implementation details. Verify the organization has documented how this control is satisfied.
...
| ------- | -------- | ------ |
| AC-16(3) Maintenance of Attribute Associations by System not implemented | High | Access Control |
| AC-16(3) partially implemented | Medium | Incomplete Access Control |
...
- [NIST SP 800-53 Rev 5 - AC-16(3)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=ac-16.3)
