...
- [ ] Verify AC-16(1) Dynamic Attribute Association is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for AC-16(1)
...
| ------- | -------- | ------ |
| AC-16(1) Dynamic Attribute Association not implemented | High | Access Control |
| AC-16(1) partially implemented | Medium | Incomplete Access Control |
...
- [NIST SP 800-53 Rev 5 - AC-16(1)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=ac-16.1)
