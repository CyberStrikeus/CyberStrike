---
name: "AC-6(8)_privilege-levels-for-code-execution"
description: "Prevent the following software from executing at higher privilege levels than users executing the software: [organization-defined]."
...
- [ ] Verify AC-6(8) Privilege Levels for Code Execution is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for AC-6(8)
...
Examine the System Security Plan (SSP) and related artifacts for AC-6(8) implementation details. Verify the organization has documented how this control is satisfied.
...
- [NIST SP 800-53 Rev 5 - AC-6(8)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=ac-6.8)
