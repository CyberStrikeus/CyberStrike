---
name: "AC-3(5)_security-relevant-information"
description: "Prevent access to [organization-defined] except during secure, non-operable system states."
...
- [ ] Verify AC-3(5) Security-relevant Information is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for AC-3(5)
...
Examine the System Security Plan (SSP) and related artifacts for AC-3(5) implementation details. Verify the organization has documented how this control is satisfied.
...
- [NIST SP 800-53 Rev 5 - AC-3(5)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=ac-3.5)
...
- [ ] Related controls (CM-6, SC-39) reviewed
