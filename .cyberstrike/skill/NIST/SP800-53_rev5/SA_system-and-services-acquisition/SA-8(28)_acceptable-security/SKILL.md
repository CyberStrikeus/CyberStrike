---
name: "SA-8(28)_acceptable-security"
description: "Implement the security design principle of acceptable security in [organization-defined]."
...
- [ ] Verify SA-8(28) Acceptable Security is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for SA-8(28)
...
Examine the System Security Plan (SSP) and related artifacts for SA-8(28) implementation details. Verify the organization has documented how this control is satisfied.
...
| ------- | -------- | ------ |
| SA-8(28) Acceptable Security not implemented | Medium | System and Services Acquisition |
| SA-8(28) partially implemented | Low | Incomplete System and Services Acquisition |
...
- [NIST SP 800-53 Rev 5 - SA-8(28)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=sa-8.28)
