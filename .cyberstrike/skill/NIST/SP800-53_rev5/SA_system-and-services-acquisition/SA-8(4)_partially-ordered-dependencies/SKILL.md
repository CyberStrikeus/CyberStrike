---
name: "SA-8(4)_partially-ordered-dependencies"
description: "Implement the security design principle of partially ordered dependencies in [organization-defined]."
...
- [ ] Verify SA-8(4) Partially Ordered Dependencies is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for SA-8(4)
...
Examine the System Security Plan (SSP) and related artifacts for SA-8(4) implementation details. Verify the organization has documented how this control is satisfied.
...
| ------- | -------- | ------ |
| SA-8(4) Partially Ordered Dependencies not implemented | Medium | System and Services Acquisition |
| SA-8(4) partially implemented | Low | Incomplete System and Services Acquisition |
...
- [NIST SP 800-53 Rev 5 - SA-8(4)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=sa-8.4)
