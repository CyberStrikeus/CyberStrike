---
name: "SI-10(6)_injection-prevention"
...
- [ ] Verify SI-10(6) Injection Prevention is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for SI-10(6)
...
Examine the System Security Plan (SSP) and related artifacts for SI-10(6) implementation details. Verify the organization has documented how this control is satisfied.
...
| ------- | -------- | ------ |
| SI-10(6) Injection Prevention not implemented | High | System and Information Integrity |
| SI-10(6) partially implemented | Medium | Incomplete System and Information Integrity |
...
- [NIST SP 800-53 Rev 5 - SI-10(6)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=si-10.6)
