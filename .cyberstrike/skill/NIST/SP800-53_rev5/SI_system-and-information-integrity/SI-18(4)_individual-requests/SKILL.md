---
name: "SI-18(4)_individual-requests"
...
- [ ] Verify SI-18(4) Individual Requests is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for SI-18(4)
...
Examine the System Security Plan (SSP) and related artifacts for SI-18(4) implementation details. Verify the organization has documented how this control is satisfied.
...
| ------- | -------- | ------ |
| SI-18(4) Individual Requests not implemented | High | System and Information Integrity |
| SI-18(4) partially implemented | Medium | Incomplete System and Information Integrity |
...
- [NIST SP 800-53 Rev 5 - SI-18(4)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=si-18.4)
