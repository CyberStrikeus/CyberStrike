---
name: "SI-7(17)_runtime-application-self-protection"
description: "Implement [organization-defined] for application self-protection at runtime."
...
prerequisites:
  - SI-7
severity_boost:
  SI-16: "Chain with SI-16 for comprehensive security coverage"
---
...
- [ ] Verify SI-7(17) Runtime Application Self-protection is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for SI-7(17)
...
Examine the System Security Plan (SSP) and related artifacts for SI-7(17) implementation details. Verify the organization has documented how this control is satisfied.
...
- [NIST SP 800-53 Rev 5 - SI-7(17)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=si-7.17)
...
- [ ] Related controls (SI-16) reviewed
