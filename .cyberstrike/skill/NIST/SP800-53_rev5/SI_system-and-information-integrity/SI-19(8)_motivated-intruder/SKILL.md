---
name: "SI-19(8)_motivated-intruder"
description: "Perform a motivated intruder test on the de-identified dataset to determine if the identified data remains or if the de-identified data can be re-iden"
...
- [ ] Verify SI-19(8) Motivated Intruder is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for SI-19(8)
...
Examine the System Security Plan (SSP) and related artifacts for SI-19(8) implementation details. Verify the organization has documented how this control is satisfied.
...
- [NIST SP 800-53 Rev 5 - SI-19(8)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=si-19.8)
