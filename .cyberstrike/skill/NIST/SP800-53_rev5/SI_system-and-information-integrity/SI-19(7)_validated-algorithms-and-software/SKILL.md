---
name: "SI-19(7)_validated-algorithms-and-software"
...
- [ ] Verify SI-19(7) Validated Algorithms and Software is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for SI-19(7)
...
Examine the System Security Plan (SSP) and related artifacts for SI-19(7) implementation details. Verify the organization has documented how this control is satisfied.
...
| ------- | -------- | ------ |
| SI-19(7) Validated Algorithms and Software not implemented | High | System and Information Integrity |
| SI-19(7) partially implemented | Medium | Incomplete System and Information Integrity |
...
- [NIST SP 800-53 Rev 5 - SI-19(7)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=si-19.7)
