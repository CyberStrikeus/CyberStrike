---
name: "SI-7(6)_cryptographic-protection"
...
- [ ] Verify SI-7(6) Cryptographic Protection is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for SI-7(6)
...
Examine the System Security Plan (SSP) and related artifacts for SI-7(6) implementation details. Verify the organization has documented how this control is satisfied.
...
| ------- | -------- | ------ |
| SI-7(6) Cryptographic Protection not implemented | High | System and Information Integrity |
| SI-7(6) partially implemented | Medium | Incomplete System and Information Integrity |
...
- [NIST SP 800-53 Rev 5 - SI-7(6)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=si-7.6)
