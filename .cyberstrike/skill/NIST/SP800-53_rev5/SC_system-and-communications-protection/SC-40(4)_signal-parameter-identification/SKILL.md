---
name: "SC-40(4)_signal-parameter-identification"
description: "Implement cryptographic mechanisms to prevent the identification of [organization-defined] by using the transmitter signal parameters."
...
- [ ] Verify SC-40(4) Signal Parameter Identification is documented in SSP
- [ ] Confirm control is operating effectively
- [ ] Review evidence of continuous monitoring for SC-40(4)
...
Examine the System Security Plan (SSP) and related artifacts for SC-40(4) implementation details. Verify the organization has documented how this control is satisfied.
...
| ------- | -------- | ------ |
| SC-40(4) Signal Parameter Identification not implemented | High | System and Communications Protection |
| SC-40(4) partially implemented | Medium | Incomplete System and Communications Protection |
...
- [NIST SP 800-53 Rev 5 - SC-40(4)](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_1/home?element=sc-40.4)
