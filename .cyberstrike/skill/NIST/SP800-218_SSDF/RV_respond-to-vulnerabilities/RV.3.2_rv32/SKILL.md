...
- [ ] Verify RV.3.2 RV.3.2 is integrated into SDLC
- [ ] Review CI/CD pipeline for RV.3.2 implementation
...
Examine development lifecycle documentation for evidence of RV.3.2 practice implementation.
...
Verify development team understands and follows RV.3.2 RV.3.2 practice.
...
Implement RV.3.2 RV.3.2 in the software development lifecycle:
...
| ------- | -------- | ------ |
| RV.3.2 RV.3.2 not implemented | Medium | Secure Development - Respond to Vulnerabilities |
