...
- [ ] Verify RV.2.1 RV.2.1 is integrated into SDLC
- [ ] Review CI/CD pipeline for RV.2.1 implementation
...
Examine development lifecycle documentation for evidence of RV.2.1 practice implementation.
...
Verify development team understands and follows RV.2.1 RV.2.1 practice.
...
Implement RV.2.1 RV.2.1 in the software development lifecycle:
