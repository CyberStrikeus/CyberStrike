...
- [ ] Verify PW.9.2 PW.9.2 is integrated into SDLC
- [ ] Review CI/CD pipeline for PW.9.2 implementation
...
Examine development lifecycle documentation for evidence of PW.9.2 practice implementation.
...
Verify development team understands and follows PW.9.2 PW.9.2 practice.
...
Implement PW.9.2 PW.9.2 in the software development lifecycle:
...
| ------- | -------- | ------ |
| PW.9.2 PW.9.2 not implemented | Medium | Secure Development - Produce Well-Secured Software |
