---
name: "PO.4.2_po42"
description: "Implement processes, mechanisms, etc."
...
- [ ] Verify PO.4.2 PO.4.2 is integrated into SDLC
- [ ] Review CI/CD pipeline for PO.4.2 implementation
...
Examine development lifecycle documentation for evidence of PO.4.2 practice implementation.
...
Verify development team understands and follows PO.4.2 PO.4.2 practice.
...
Implement PO.4.2 PO.4.2 in the software development lifecycle:
...
| ------- | -------- | ------ |
| PO.4.2 PO.4.2 not implemented | Medium | Secure Development - Prepare the Organization |
