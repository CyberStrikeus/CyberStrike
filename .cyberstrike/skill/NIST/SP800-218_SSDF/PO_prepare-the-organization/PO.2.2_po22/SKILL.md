---
name: "PO.2.2_po22"
description: "Provide role-based training for all personnel with responsibilities that contribute to secure development."
...
- [ ] Verify PO.2.2 PO.2.2 is integrated into SDLC
- [ ] Review CI/CD pipeline for PO.2.2 implementation
...
Examine development lifecycle documentation for evidence of PO.2.2 practice implementation.
...
Verify development team understands and follows PO.2.2 PO.2.2 practice.
...
Implement PO.2.2 PO.2.2 in the software development lifecycle:
...
| ------- | -------- | ------ |
| PO.2.2 PO.2.2 not implemented | Medium | Secure Development - Prepare the Organization |
