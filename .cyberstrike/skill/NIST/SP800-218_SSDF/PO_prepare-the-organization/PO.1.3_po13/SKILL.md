---
name: "PO.1.3_po13"
description: "Communicate requirements to all third parties who will provide commercial software components to the organization for reuse by the organization’s o..."
...
- [ ] Verify PO.1.3 PO.1.3 is integrated into SDLC
- [ ] Review CI/CD pipeline for PO.1.3 implementation
...
Examine development lifecycle documentation for evidence of PO.1.3 practice implementation.
...
Verify development team understands and follows PO.1.3 PO.1.3 practice.
...
Implement PO.1.3 PO.1.3 in the software development lifecycle:
...
| ------- | -------- | ------ |
| PO.1.3 PO.1.3 not implemented | Medium | Secure Development - Prepare the Organization |
