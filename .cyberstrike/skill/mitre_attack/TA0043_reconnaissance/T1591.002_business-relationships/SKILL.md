---
name: "T1591.002_business-relationships"
...
- [ ] Identify if Business Relationships technique is applicable to target environment
- [ ] Check PRE systems for indicators of Business Relationships
...
1. **Identify Attack Surface**: Determine if the target environment is susceptible to Business Relationships by examining the target platforms (PRE).

2. **Assess Existing Defenses**: Review whether mitigations for T1591.002 are in place. If defenses are absent or misconfigured, this technique may be exploitable.
...
| ------- | -------- | ------ |
| Business Relationships technique applicable | High | Reconnaissance |
...
- [Atomic Red Team - T1591.002](https://github.com/redcanaryco/atomic-red-team/tree/master/atomics/T1591.002)
