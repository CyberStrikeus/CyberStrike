---
name: "T1583.007_serverless"
description: "Adversaries may purchase and configure serverless cloud infrastructure, such as Cloudflare Workers, AWS Lambda functions, or Google Apps Scripts, that can be used during targeting."
...
2. **Assess Existing Defenses**: Review whether mitigations for T1583.007 are in place. If defenses are absent or misconfigured, this technique may be exploitable.
...
- [Atomic Red Team - T1583.007](https://github.com/redcanaryco/atomic-red-team/tree/master/atomics/T1583.007)
- [MITRE ATT&CK - T1583.007](https://attack.mitre.org/techniques/T1583/007)
