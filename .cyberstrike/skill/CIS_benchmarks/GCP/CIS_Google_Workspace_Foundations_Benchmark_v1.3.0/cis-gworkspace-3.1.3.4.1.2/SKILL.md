---
name: cis-gworkspace-3.1.3.4.1.2
...
cwe_ids: []
chains_with: [cis-gworkspace-3.1.3.4.1.1, cis-gworkspace-3.1.3.4.1.3]
prerequisites: []
severity_boost: {}
---

# 3.1.3.4.1.2 Ensure protection against attachments with scripts from untrusted senders is enabled
