...
# 3.1.1.1.1 Ensure external sharing options for primary calendars are configured (Manual)
...
`Only free/busy information (hide event details)` should be selected for external sharing options for primary calendars.
