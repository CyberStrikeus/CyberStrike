---
name: cis-gcp-cos-1.5.1.2
description: "Ensure local login warning banner is configured properly"
category: cis-gcp-cos
version: "1.2.0"
author: cyberstrike-official
tags: [cis, gcp, container-optimized-os, banners, login-banner, information-disclosure]
cis_id: "1.5.1.2"
...
The `/etc/issue` file should contain the appropriate site policy message. The grep command should return no results (no OS information leakage).
