...
A log metric filter exists matching the custom role changes filter, and at least one alert policy is configured and enabled for it.
...
1. Identify the metric that was just created under the section `User-defined Metrics` at https://console.cloud.google.com/logs/metrics.
