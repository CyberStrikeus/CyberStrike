---
name: cis-azure-foundations-6.1.2.10
description: "Ensure Activity Log Alert exists for Delete Public IP Address rule"
...
tech_stack: [azure]
cwe_ids: []
chains_with: [cis-azure-foundations-6.1.2.9]
prerequisites: []
severity_boost: {}
---
...
An activity log alert rule should exist with the operation name `Microsoft.Network/publicIPAddresses/delete` and an action group assigned.
