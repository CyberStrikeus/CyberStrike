---
name: cis-azure-foundations-6.1.2.7
description: "Ensure Activity Log Alert exists for Create or Update SQL Server Firewall Rule"
...
tech_stack: [azure]
cwe_ids: []
chains_with: [cis-azure-foundations-6.1.2.8]
prerequisites: []
severity_boost: {}
---
...
An activity log alert rule should exist with the operation name `Microsoft.Sql/servers/firewallRules/write` and an action group assigned.
