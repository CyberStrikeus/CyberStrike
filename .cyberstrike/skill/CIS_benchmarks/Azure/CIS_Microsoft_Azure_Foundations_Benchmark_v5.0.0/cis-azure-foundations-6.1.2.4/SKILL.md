---
name: cis-azure-foundations-6.1.2.4
description: "Ensure Activity Log Alert exists for Delete Network Security Group"
...
tech_stack: [azure]
cwe_ids: []
chains_with: [cis-azure-foundations-6.1.2.3]
prerequisites: []
severity_boost: {}
---
...
An activity log alert rule should exist with the operation name `Microsoft.Network/networkSecurityGroups/delete` and an action group assigned.
