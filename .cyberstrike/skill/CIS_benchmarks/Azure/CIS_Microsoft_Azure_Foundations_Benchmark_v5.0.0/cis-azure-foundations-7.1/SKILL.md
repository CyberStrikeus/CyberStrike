---
name: cis-azure-foundations-7.1
description: "Ensure RDP access from the Internet is evaluated and restricted"
...
tech_stack: [azure]
cwe_ids: []
chains_with: [cis-azure-foundations-7.2, cis-azure-foundations-7.3, cis-azure-foundations-7.4, cis-azure-foundations-7.11]
prerequisites: []
severity_boost: {}
---
...
None documented. Restricting RDP access from the Internet is a security best practice with no negative functional impact when properly configured with alternative access methods such as VPN, ExpressRoute, or Azure Bastion.
...
No inbound security rules should allow unrestricted RDP access (port 3389) from the Internet. The Azure Resource Graph query should return zero results.
