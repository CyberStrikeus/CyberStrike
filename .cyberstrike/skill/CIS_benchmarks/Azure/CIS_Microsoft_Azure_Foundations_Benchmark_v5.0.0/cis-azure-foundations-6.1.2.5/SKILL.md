---
name: cis-azure-foundations-6.1.2.5
description: "Ensure Activity Log Alert exists for Create or Update Security Solution"
category: cis-azure-foundations
version: "5.0.0"
author: cyberstrike-official
tags: [cis, azure, logging, monitoring, activity-log-alerts, security]
cis_id: "6.1.2.5"
cis_benchmark: "CIS Microsoft Azure Foundations Benchmark v5.0.0"
tech_stack: [azure]
cwe_ids: []
chains_with: [cis-azure-foundations-6.1.2.6]
prerequisites: []
severity_boost: {}
---
...
An activity log alert rule should exist with the operation name `Microsoft.Security/securitySolutions/write` and an action group assigned.
