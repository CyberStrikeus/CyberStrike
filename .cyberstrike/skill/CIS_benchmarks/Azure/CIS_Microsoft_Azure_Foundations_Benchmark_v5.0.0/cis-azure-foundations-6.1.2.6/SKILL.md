---
name: cis-azure-foundations-6.1.2.6
description: "Ensure Activity Log Alert exists for Delete Security Solution"
...
tech_stack: [azure]
cwe_ids: []
chains_with: [cis-azure-foundations-6.1.2.5]
prerequisites: []
severity_boost: {}
---
...
An activity log alert rule should exist with the operation name `Microsoft.Security/securitySolutions/delete` and an action group assigned.
