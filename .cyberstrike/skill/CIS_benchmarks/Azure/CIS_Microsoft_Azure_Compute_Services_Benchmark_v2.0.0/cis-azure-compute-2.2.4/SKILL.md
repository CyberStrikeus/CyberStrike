---
name: cis-azure-compute-2.2.4
description: "Ensure 'Basic Authentication Publishing Credentials' are 'Disabled'"
category: cis-azure-compute
version: "2.0.0"
author: cyberstrike-official
tags: [cis, azure, app-service, deployment-slots, basic-auth, authentication, publishing-credentials]
cis_id: "2.2.4"
...
Both `SCM Basic Auth Publishing Credentials` and `FTP Basic Auth Publishing Credentials` should return `false`, indicating they are disabled.
