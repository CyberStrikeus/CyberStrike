...
tags: [cis, kubernetes, worker-node, kubelet, event-recording, logging]
cis_id: "4.2.8"
...
| v7 | 6.2 Activate audit logging - Ensure local logging has been enabled on all systems and networking devices. | * | * | * |
