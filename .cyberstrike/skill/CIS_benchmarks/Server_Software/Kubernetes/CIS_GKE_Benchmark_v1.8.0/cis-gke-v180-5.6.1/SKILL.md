...
Using Command Line:
To check for Intranode Visibility in the cluster, first define 2 variables Cluster Name and Zone and then run the following command for each Node pool:
