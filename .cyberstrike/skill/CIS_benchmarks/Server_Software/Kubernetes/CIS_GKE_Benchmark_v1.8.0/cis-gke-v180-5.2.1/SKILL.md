...
Using Command line:
To check an existing cluster, first define 3 variables for Node Pool, Cluster Name and Zone, and then run the following command:
...
The output of the above command will return default if default Service account is used or the specific account being used for Project access.
