...
Using Command Line:
To check Master Authorized Networks status for an existing cluster, first define 2 variables Cluster Name and Zone and then run the following command:
