...
Using Command Line
To check whether the GKE Metadata Server is enabled for each Node pool within a cluster define 2 variables for Cluster Name and Zone and then run the following command:
