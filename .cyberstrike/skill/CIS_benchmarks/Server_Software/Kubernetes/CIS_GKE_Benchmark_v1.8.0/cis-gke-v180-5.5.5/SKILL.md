...
Using Command Line:
To check for Shielded GKE Nodes within a cluster, first define 2 variables for Cluster Name and Zone and then run the following command:
