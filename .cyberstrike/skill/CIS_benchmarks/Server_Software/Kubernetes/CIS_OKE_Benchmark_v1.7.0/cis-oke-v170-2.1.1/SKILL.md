...
# CIS OKE Benchmark v1.7.0 - Control 2.1.1
...
You can verify the availability of client certificates in your OKE cluster. Run the following command to verify the availability of client certificates in your OKE cluster:
