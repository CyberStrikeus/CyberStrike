# CIS Oracle Cloud Infrastructure Container Engine for Kubernetes (OKE) Benchmark v1.7.0 - Skills

This directory contains **46 SKILL.md files** for the CIS OKE Benchmark v1.7.0.
...
- Original PDF: `CIS_Oracle_Cloud_Infrastructure_Container_Engine_for_Kubernetes(OKE)_Benchmark_v1.7.0_PDF.pdf`
