...
# CIS Red Hat OpenShift Container Platform Benchmark v1.7.0 - Control 5.1.2
...
## Audit Procedure
Review the users who have `get`, `list` or `watch` access to `secrets` objects in the Kubernetes API. Executing the command below will return a list of users and groups who are allowed to get secrets:
