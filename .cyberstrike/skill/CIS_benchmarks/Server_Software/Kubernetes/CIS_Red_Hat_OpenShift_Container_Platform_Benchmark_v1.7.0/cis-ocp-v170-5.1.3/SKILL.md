...
# CIS Red Hat OpenShift Container Platform Benchmark v1.7.0 - Control 5.1.3
...
## Default Value
By default, OpenShift includes several cluster roles with wildcard permissions for system components.
