# CIS Google Kubernetes Engine (GKE) Benchmark v1.9.0 - Skills

This directory contains **57 SKILL.md files** for the CIS Google Kubernetes Engine (GKE) Benchmark v1.9.0.
...
- 5.10.5 Security Posture renumbered to 5.10.4 and changed from Manual to Automated
- Assessment status changes: 4.1.1, 4.1.2, 4.1.3, 4.1.5, 4.6.4 changed from Automated to Manual

## Directory Structure

```
cis-gke-v190-{control_id}/
└── SKILL.md
```
...
- Platform: Google Cloud GKE (Standard)
- Original PDF: `CIS_Google_Kubernetes_Engine_(GKE)_Benchmark_v1.9.0_PDF.pdf`
