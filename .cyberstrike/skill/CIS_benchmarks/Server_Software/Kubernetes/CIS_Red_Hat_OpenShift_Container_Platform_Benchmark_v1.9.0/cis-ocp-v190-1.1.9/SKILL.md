...
# CIS Red Hat OpenShift Container Platform Benchmark v1.9.0 - Control 1.1.9
...
`/host/etc/cni/net.d` = CNI_CONF_DIR `/host/var/run/multus/cni/net.d` = multus config dir
