...
tags: [cis, openshift, kubernetes, redhat, control-plane, master-node-config-files, controller-manager, file-permissions]
cis_id: "1.1.3"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.9.0 - Control 1.1.3
