---
name: cis-ocp-v190-1.2.5
description: "Ensure that the --authorization-mode argument is not set to AlwaysAllow (Manual)"
category: cis-openshift
version: "1.9.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, api-server, authorization, rbac]
cis_id: "1.2.5"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.9.0 - Control 1.2.5
