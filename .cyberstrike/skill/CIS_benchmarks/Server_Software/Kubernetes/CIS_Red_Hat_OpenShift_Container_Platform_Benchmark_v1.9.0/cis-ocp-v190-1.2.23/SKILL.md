---
name: cis-ocp-v190-1.2.23
description: "Ensure that the --service-account-lookup argument is set to true (Manual)"
category: cis-openshift
version: "1.9.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, api-server, service-account, authentication]
cis_id: "1.2.23"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.9.0 - Control 1.2.23
