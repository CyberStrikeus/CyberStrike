---
name: cis-ocp-v190-1.1.2
description: "Ensure that the API server pod specification file ownership is set to root:root (Manual)"
category: cis-openshift
version: "1.9.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, master-node-config-files, api-server, file-ownership]
cis_id: "1.1.2"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.9.0 - Control 1.1.2
