---
name: cis-ocp-v190-1.2.10
description: "Ensure that the admission control plugin ServiceAccount is set (Manual)"
category: cis-openshift
version: "1.9.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, api-server, admission-control, service-account]
cis_id: "1.2.10"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.9.0 - Control 1.2.10
