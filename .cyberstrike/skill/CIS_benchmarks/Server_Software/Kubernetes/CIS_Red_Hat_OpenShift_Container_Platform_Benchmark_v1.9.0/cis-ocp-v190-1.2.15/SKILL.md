---
name: cis-ocp-v190-1.2.15
description: "Ensure that the --insecure-port argument is set to 0 (Manual)"
category: cis-openshift
version: "1.9.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, api-server, network, insecure-port]
cis_id: "1.2.15"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.9.0 - Control 1.2.15
