---
name: cis-ocp-v190-1.1.21
description: "Ensure that the OpenShift PKI key file permissions are set to 600 (Manual)"
category: cis-openshift
version: "1.9.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, master-node-config-files, pki, key-files, file-permissions]
cis_id: "1.1.21"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.9.0 - Control 1.1.21
