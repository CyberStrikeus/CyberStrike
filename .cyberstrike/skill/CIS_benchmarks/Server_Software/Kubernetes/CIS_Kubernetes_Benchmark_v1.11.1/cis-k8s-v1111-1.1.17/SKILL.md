---
name: cis-k8s-v1111-1.1.17
description: "Ensure that the controller-manager.conf file permissions are set to 600 or more restrictive (Automated)"
category: cis-k8s
version: "1.11.1"
author: cyberstrike-official
tags: [cis, kubernetes, control-plane, configuration-files, permissions, controller-manager, kubeconfig]
cis_id: "1.1.17"
...
# CIS Kubernetes Benchmark v1.11.1 - Control 1.1.17
