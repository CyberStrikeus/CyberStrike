...
tags: [cis, kubernetes, control-plane, configuration-files, permissions, controller-manager]
cis_id: "1.1.3"
...
# CIS Kubernetes Benchmark v1.11.1 - Control 1.1.3
