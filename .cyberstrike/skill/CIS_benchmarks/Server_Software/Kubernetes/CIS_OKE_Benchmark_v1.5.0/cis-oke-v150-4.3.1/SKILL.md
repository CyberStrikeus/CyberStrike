---
name: cis-oke-v150-4.3.1
description: "Ensure latest CNI version is used (Manual)"
category: cis-oke
version: "1.5.0"
author: cyberstrike-official
tags: [cis, oke, kubernetes, oci, policies, cni, network-policies]
cis_id: "4.3.1"
...
Look for known CNI providers like Calico, Flannel, Cilium, etc. You can further inspect the configuration of these DaemonSets to understand more about the CNI setup:
