# CIS Oracle Cloud Infrastructure Container Engine for Kubernetes (OKE) Benchmark v1.5.0 - Skills

This directory contains **46 SKILL.md files** for the CIS OKE Benchmark v1.5.0.
...
- Original PDF: `CIS Oracle Cloud Infrastructure (OKE) Benchmark v1.5.0 PDF.pdf`
