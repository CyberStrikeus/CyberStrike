---
name: cis-oke-v150-2.1.1
description: "Client certificate authentication should not be used for users (Automated)"
category: cis-oke
version: "1.5.0"
...
# 2.1.1 Client certificate authentication should not be used for users (Automated)
...
1. [https://cloud.google.com/kubernetes-engine/docs/concepts/cis-benchmarks](https://cloud.google.com/kubernetes-engine/docs/concepts/cis-benchmarks)
