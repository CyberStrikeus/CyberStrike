# CIS Google Kubernetes Engine (GKE) Autopilot Benchmark v1.2.0 - Skills

This directory contains **32 SKILL.md files** for the CIS Google Kubernetes Engine (GKE) Autopilot Benchmark v1.2.0.
...
```
cis-gke-autopilot-v120-{control_id}/
└── SKILL.md
```
