---
name: cis-ocp-v180-1.3.2
description: "Ensure --use-service-account-credentials set to true (Manual)"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.8.0 - Control 1.3.2
