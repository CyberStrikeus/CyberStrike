...
# CIS Red Hat OpenShift Container Platform Benchmark v1.8.0 - Control 1.2.29
...
## Remediation
Follow the OpenShift documentation for [encrypting etcd data](https://docs.openshift.com/container-platform/latest/security/encrypting-etcd.html).
