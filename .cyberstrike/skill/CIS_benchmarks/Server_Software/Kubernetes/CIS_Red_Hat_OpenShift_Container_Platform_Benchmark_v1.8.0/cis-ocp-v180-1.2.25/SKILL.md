---
name: cis-ocp-v180-1.2.25
description: "Ensure that the --etcd-certfile and --etcd-keyfile arguments are set (Manual)"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.8.0 - Control 1.2.25
...
## Default Value
By default, OpenShift uses X.509 certificates to provide secure communication to `etcd`. OpenShift does not use the `etcd-certfile` or `etcd-keyfile` flags. OpenShift generates the necessary files and sets the arguments appropriately.
