...
# CIS Red Hat OpenShift Container Platform Benchmark v1.8.0 - Control 4.2.9
...
'.data["config.yaml"]' | jq '.apiServerArguments."kubelet-client-certificate"'
```
