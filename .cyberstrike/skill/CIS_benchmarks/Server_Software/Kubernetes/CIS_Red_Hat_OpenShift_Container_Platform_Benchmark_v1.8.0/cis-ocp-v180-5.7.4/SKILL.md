...
# CIS Red Hat OpenShift Container Platform Benchmark v1.8.0 - Control 5.7.4
...
Run the following command to list all resources in the `default` namespace, besides `kubernetes` and `openshift` services, which are expected to be in the `default` namespace:
