...
tags: [cis, kubernetes, control-plane, api-server, admission-control, external-ips]
cis_id: "1.2.3"
...
1. [https://kubernetes.io/docs/reference/access-authn-authz/admission-controllers/](https://kubernetes.io/docs/reference/access-authn-authz/admission-controllers/)
