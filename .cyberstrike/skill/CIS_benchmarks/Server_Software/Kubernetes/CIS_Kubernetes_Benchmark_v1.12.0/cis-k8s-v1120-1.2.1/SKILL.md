---
name: cis-k8s-v1120-1.2.1
description: "Ensure that the --anonymous-auth argument is set to false (Manual)"
category: cis-k8s
version: "1.12.0"
author: cyberstrike-official
tags: [cis, kubernetes, control-plane, api-server, authentication, anonymous-auth]
cis_id: "1.2.1"
...
2. [https://kubernetes.io/docs/admin/authentication/#anonymous-requests](https://kubernetes.io/docs/admin/authentication/#anonymous-requests)
