---
name: cis-ocp-v160-1.1.11
description: "Ensure that the etcd data directory permissions are set to 700 or more restrictive (Manual)"
category: cis-openshift
version: "1.6.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, master-node-config-files, etcd, data-directory, file-permissions]
cis_id: "1.1.11"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.6.0 - Control 1.1.11
