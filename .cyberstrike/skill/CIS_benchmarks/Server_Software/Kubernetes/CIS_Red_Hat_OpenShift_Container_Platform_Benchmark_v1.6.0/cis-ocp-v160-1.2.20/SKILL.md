---
name: cis-ocp-v160-1.2.20
description: "Ensure that the --audit-log-path argument is set (Manual)"
category: cis-openshift
version: "1.6.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, api-server, audit-log]
cis_id: "1.2.20"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.6.0 - Control 1.2.20
