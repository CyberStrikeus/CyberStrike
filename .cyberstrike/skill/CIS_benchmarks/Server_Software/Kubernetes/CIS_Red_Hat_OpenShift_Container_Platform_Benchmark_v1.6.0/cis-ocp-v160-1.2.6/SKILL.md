---
name: cis-ocp-v160-1.2.6
description: "Verify that the kubelet certificate authority is set as appropriate (Manual)"
category: cis-openshift
version: "1.6.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, api-server, kubelet-ca]
cis_id: "1.2.6"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.6.0 - Control 1.2.6
...
Verify the ca-bundle.crt is located as following: `/etc/kubernetes/static-pod-resources/configmaps/kubelet-serving-ca/ca-bundle.crt`
