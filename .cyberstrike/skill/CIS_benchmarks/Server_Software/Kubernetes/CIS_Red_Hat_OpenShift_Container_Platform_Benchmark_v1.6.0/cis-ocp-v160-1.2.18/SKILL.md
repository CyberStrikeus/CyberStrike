---
name: cis-ocp-v160-1.2.18
description: "Ensure that the --secure-port argument is not set to 0 (Manual)"
category: cis-openshift
version: "1.6.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, api-server, secure-port]
cis_id: "1.2.18"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.6.0 - Control 1.2.18
