---
name: cis-ocp-v160-1.1.4
description: "Ensure that the controller manager pod specification file ownership is set to root:root (Manual)"
category: cis-openshift
version: "1.6.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, master-node-config-files, controller-manager, file-ownership]
cis_id: "1.1.4"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.6.0 - Control 1.1.4
