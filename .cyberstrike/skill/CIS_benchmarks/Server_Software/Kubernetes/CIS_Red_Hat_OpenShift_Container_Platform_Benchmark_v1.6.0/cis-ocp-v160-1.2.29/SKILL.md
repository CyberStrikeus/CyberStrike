---
name: cis-ocp-v160-1.2.29
description: "Ensure that the --client-ca-file argument is set as appropriate (Manual)"
category: cis-openshift
version: "1.6.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, api-server, client-ca]
cis_id: "1.2.29"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.6.0 - Control 1.2.29
...
Verify that the following file exists: `/etc/kubernetes/static-pod-certs/configmaps/client-ca/ca-bundle.crt`
