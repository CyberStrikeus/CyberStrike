---
name: cis-ocp-v160-1.1.14
description: "Ensure that the kubeconfig file ownership is set to root:root (Manual)"
category: cis-openshift
version: "1.6.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, master-node-config-files, kubeconfig, admin-config, file-ownership]
cis_id: "1.1.14"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.6.0 - Control 1.1.14
