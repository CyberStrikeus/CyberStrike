---
name: cis-ocp-v160-1.1.13
description: "Ensure that the kubeconfig file permissions are set to 600 or more restrictive (Manual)"
category: cis-openshift
version: "1.6.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, master-node-config-files, kubeconfig, admin-config, file-permissions]
cis_id: "1.1.13"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.6.0 - Control 1.1.13
