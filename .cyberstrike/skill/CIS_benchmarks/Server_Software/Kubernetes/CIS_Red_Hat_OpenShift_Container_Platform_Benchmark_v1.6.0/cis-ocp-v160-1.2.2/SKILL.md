---
name: cis-ocp-v160-1.2.2
description: "Ensure that the --basic-auth-file argument is not set (Manual)"
category: cis-openshift
version: "1.6.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, api-server, basic-auth]
cis_id: "1.2.2"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.6.0 - Control 1.2.2
