...
## Default Value
By default, OpenShift uses X.509 certificates to provide secure connections between the API server and node/kubelet. OpenShift does not use values assigned to `tls-cert-file` or `tls-private-key-file` flags.
