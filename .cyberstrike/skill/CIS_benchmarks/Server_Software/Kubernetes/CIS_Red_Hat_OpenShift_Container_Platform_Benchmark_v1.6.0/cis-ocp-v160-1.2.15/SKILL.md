---
name: cis-ocp-v160-1.2.15
description: "Ensure that the admission control plugin NodeRestriction is set (Manual)"
category: cis-openshift
version: "1.6.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, api-server, node-restriction]
cis_id: "1.2.15"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.6.0 - Control 1.2.15
