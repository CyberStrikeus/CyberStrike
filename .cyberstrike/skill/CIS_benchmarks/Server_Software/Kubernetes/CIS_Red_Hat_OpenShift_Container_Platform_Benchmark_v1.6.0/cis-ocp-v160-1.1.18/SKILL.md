---
name: cis-ocp-v160-1.1.18
description: "Ensure that the Controller Manager kubeconfig file ownership is set to root:root (Manual)"
category: cis-openshift
version: "1.6.0"
author: cyberstrike-official
tags: [cis, openshift, kubernetes, redhat, control-plane, master-node-config-files, controller-manager, kubeconfig, file-ownership]
cis_id: "1.1.18"
...
# CIS Red Hat OpenShift Container Platform Benchmark v1.6.0 - Control 1.1.18
