# CIS Google Kubernetes Engine (GKE) Autopilot Benchmark v1.0.0 - Skills

This directory contains **32 SKILL.md files** for the CIS Google Kubernetes Engine (GKE) Autopilot Benchmark v1.0.0.
...
```
cis-gke-autopilot-v100-{control_id}/
└── SKILL.md
```
...
- Platform: Google Cloud GKE Autopilot
- Original PDF: `CIS_Google_Kubernetes_Engine_(GKE)_Autopilot_Benchmark_v1.0.0 PDF.pdf`
