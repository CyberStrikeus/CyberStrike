---
name: cis-aks-v180-4.1.6
description: "Ensure Service Account Tokens are only mounted where necessary (Manual)"
category: cis-aks
version: "1.8.0"
...
# 4.1.6 Ensure Service Account Tokens are only mounted where necessary (Manual)
