---
name: cis-tomcat7-v110-6.4
description: "Ensure secure is set to true only for SSL-enabled Connectors"
category: cis-tomcat
version: "1.1.0"
author: cyberstrike-official
tags: [cis, tomcat, tomcat-7, ssl-tls,connectors,security-context]
cis_id: "6.4"
...
# CIS Apache Tomcat 7 Benchmark v1.1.0 - Control 6.4
...
Refer to CIS Apache Tomcat 7 Benchmark v1.1.0 - Section 6.4
