---
name: cis-docker-v160-1.1.18
description: "Ensure auditing is configured for Docker files and directories - /usr/bin/runc"
category: cis-docker
version: "1.6.0"
author: cyberstrike-official
tags: [cis, docker, host-configuration, auditing, logging, runc, binary, linux]
cis_id: "1.1.18"
...
# CIS Docker Benchmark v1.6.0 - 1.1.18
...
As well as auditing the normal Linux file system and system calls, you should audit all Docker related files and directories. The Docker daemon runs with `root` privileges and its behavior depends on some key files and directories. `/usr/bin/runc` is one such file, and as such it should be audited.
