---
name: cis-docker-v160-1.1.2
description: "Ensure only trusted users are allowed to control Docker daemon"
category: cis-docker
version: "1.6.0"
author: cyberstrike-official
tags: [cis, docker, host-configuration, access-control, docker-group, linux]
cis_id: "1.1.2"
...
# CIS Docker Benchmark v1.6.0 - 1.1.2
...
The Docker daemon currently requires `root` access to the Docker socket which is, by default, owned by the user `root` and the group `docker`.
