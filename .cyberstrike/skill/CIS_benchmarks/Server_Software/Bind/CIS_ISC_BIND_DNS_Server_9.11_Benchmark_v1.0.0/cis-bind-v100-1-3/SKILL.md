...
## Remediation
**Authoritative-Only Name Server:**
For the authoritative-only name server add or modify the allow-recursion statement to only include the localhost as shown below, or add a recursion statement with a value of *no* as shown below.
