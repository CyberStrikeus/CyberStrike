---
name: cis-ubuntu1804-v220-5-2-3-15
description: Ensure successful and unsuccessful attempts to use the chcon command are recorded
version: "2.2.0"
...
# CIS Ubuntu 18.04 - Ensure successful and unsuccessful attempts to use the chcon command are recorded (5.2.3.15)

## Metadata
- **ID**: cis-ubuntu1804-v220-5-2-3-15
- **Title**: Ensure successful and unsuccessful attempts to use the chcon command are recorded
- **CIS Control**: 5.2.3.15
