---
name: cis-ubuntu1804-v220-1-1-1-4
description: "Ensure mounting of hfs filesystems is disabled"
category: cis-storage
version: "2.2.0"
author: cyberstrike-official
tags: [cis, ubuntu, linux, ubuntu-18.04, filesystem, hfs, kernel-module]
cis_id: "1.1.1.4"
...
#!/usr/bin/env bash
{
    ...
    l_mpname="$(tr '-' ' ' <<< "$l_mname")"
    l_mndir="$(tr '-' '/' <<< "$l_mname")"
    # ... (same audit script pattern as 1.1.1.1 with l_mname="hfs")
    module_loadable_chk()
    {
...
- module: "hfs" is not loadable
- module: "hfs" is not loaded
- module: "hfs" is deny listed
