---
name: cis-aws-foundations-5.10
description: "Ensure security group changes are monitored"
category: cis-monitoring
version: "7.0.0"
author: cyberstrike-official
tags: [cis, aws, monitoring, cloudwatch, cloudtrail, metric-filters, alarms, security-groups, vpc]
cis_id: "5.10"
...
## Expected Result
A metric filter exists with the filter pattern matching security group change events, a CloudWatch alarm is configured for the metric, and the alarm has an active SNS topic with at least one subscriber.
...
5. https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ModifySecurityGroupRules.html
