---
name: cis-aws-foundations-5.6
description: "Ensure AWS Management Console authentication failures are monitored"
category: cis-monitoring
version: "7.0.0"
author: cyberstrike-official
tags: [cis, aws, monitoring, cloudwatch, cloudtrail, metric-filters, alarms, console-auth-failures]
cis_id: "5.6"
...
## Expected Result
A metric filter exists with the filter pattern matching failed console authentication events, a CloudWatch alarm is configured for the metric, and the alarm has an active SNS topic with at least one subscriber.
