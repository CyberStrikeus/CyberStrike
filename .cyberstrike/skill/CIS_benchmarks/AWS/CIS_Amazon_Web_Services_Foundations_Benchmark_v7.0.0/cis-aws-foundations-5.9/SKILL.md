...
## Expected Result
A metric filter exists with the filter pattern matching AWS Config configuration change events, a CloudWatch alarm is configured for the metric, and the alarm has an active SNS topic with at least one subscriber.
