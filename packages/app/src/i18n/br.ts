export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  ...
  "dialog.provider.llmtr.note": "Modelos hospedados na Türkiye e preços com desconto nos globais",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (cyberstrike.json)",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CyberStrike dentro do WSL no Windows.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CyberStrike iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CyberStrike.",
