...
export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (cyberstrike.json) 中的 provider/model 名稱",
  ...
  "settings.updates.row.startup.description": "在 CyberStrike 啟動時自動檢查更新",
