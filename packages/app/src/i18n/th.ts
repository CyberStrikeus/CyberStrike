export const dict = {
  ...
  "dialog.provider.llmtr.note": "โมเดลที่โฮสต์ในตุรกีและราคาส่วนลดสำหรับโมเดลระดับโลก",
  ...
  "error.chain.mcpFailed":
    'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า CyberStrike ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
