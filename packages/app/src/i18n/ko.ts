...
export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  ...
  "dialog.provider.llmtr.note": "튀르키예에서 호스팅되는 모델과 글로벌 모델 할인 가격",
  ...
  "error.chain.checkConfig": "구성(cyberstrike.json)의 공급자/모델 이름을 확인하세요",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 CyberStrike 서버를 실행합니다.",
  ...
  "settings.updates.row.startup.description": "CyberStrike를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 CyberStrike를 사용 중입니다.",
