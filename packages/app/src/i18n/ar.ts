export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (cyberstrike.json)",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم CyberStrike داخل WSL على Windows.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل CyberStrike",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من CyberStrike.",
