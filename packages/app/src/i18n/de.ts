...
export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  ...
  "dialog.provider.llmtr.note": "In der Türkei gehostete Modelle und vergünstigte Preise für globale Modelle",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (cyberstrike.json) auf Anbieter-/Modellnamen",
  ...
  "settings.desktop.wsl.description": "CyberStrike-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von CyberStrike automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von CyberStrike.",
