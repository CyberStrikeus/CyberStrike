export const dict = {
  ...
  "command.bolt.toggle": "Toggle Bolt servers",
  "command.bolt.toggle.description": "Manage Bolt security servers",
  "command.vulnerability.view": "View vulnerabilities",
  "command.vulnerability.view.description": "View discovered vulnerabilities",
  "command.agent.list": "List agents",
  "command.agent.list.description": "View and select agents",
  ...
  "dialog.agent.title": "Agents",
  "dialog.agent.description": "{{primary}} primary, {{total}} total",
  "dialog.agent.current": "active",
  "dialog.agent.subagents": "Subagents",
  ...
  "dialog.provider.llmtr.note": "Türkiye-hosted models and discounted pricing on global ones",
  ...
  "dialog.mcp.add.title": "Add MCP Server",
  "dialog.mcp.add.command": "Command",
  "dialog.mcp.add.commandDescription": "Full command to start the MCP server (e.g. npx cve-mcp)",
  "dialog.mcp.add.env": "Environment Variables",
  "dialog.mcp.add.envDescription": "Comma-separated KEY=VALUE pairs, or leave empty",
  "dialog.mcp.add.url": "URL",
  "dialog.mcp.add.name": "Server Name",
  "dialog.mcp.add.connect": "Connect",
  "dialog.mcp.add.connecting": "Connecting...",
  "dialog.mcp.add.connectingMessage": "Connecting to server...",
  "dialog.mcp.add.done": "MCP Server Added",
  "dialog.mcp.add.finish": "Done",
  "dialog.mcp.add.next": "Next",
  "dialog.mcp.add.back": "Back",

  "dialog.bolt.title": "Bolt Servers",
  "dialog.bolt.description": "{{enabled}} of {{total}} active",
  "dialog.bolt.empty": "No Bolt servers configured",
  ...
  "dialog.bolt.add.pairingMessage": "Pairing with server...",
  "dialog.bolt.add.done": "Bolt Server Added",
  "dialog.bolt.add.finish": "Done",
  "dialog.bolt.add.next": "Next",
  ...
  "dialog.server.add.usernamePlaceholder": "cyberstrike",
  ...
  "hub.connect.title": "Connect to CyberStrike",
  "hub.connect.description": "Connect to your local or remote CyberStrike server",
  "hub.connect.localhost": "Local Server",
  "hub.connect.localhost.description": "Connect to CyberStrike running on localhost:4096",
  ...
  "hub.connect.url.placeholder": "https://your-tunnel.trycloudflare.com",
  "hub.connect.username": "Username",
  "hub.connect.password": "Password",
  "hub.connect.button": "Connect",
  "hub.connect.connecting": "Connecting...",
  "hub.connect.error": "Could not connect to server",
  "hub.connect.back": "Back",
  ...
  "status.popover.tab.bolt": "Bolt",
  "status.popover.tab.vulns": "Vulns",
  "status.popover.tab.todo": "Todo",
