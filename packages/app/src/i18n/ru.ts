export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  ...
  "dialog.provider.llmtr.note": "Модели, размещённые в Турции, и сниженные цены на глобальные",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (cyberstrike.json)",
  ...
  "settings.desktop.wsl.description": "Запускать сервер CyberStrike внутри WSL на Windows.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске CyberStrike",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию CyberStrike.",
