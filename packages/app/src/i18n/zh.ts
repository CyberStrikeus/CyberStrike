...
export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "使用 CyberStrike Zen 或 API 密钥连接",
  ...
  "dialog.provider.llmtr.note": "土耳其本地托管模型，全球模型享折扣价",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的帐户并在 CyberStrike 中使用 {{provider}} 模型。",
  ...
  "dialog.server.add.namePlaceholder": "我的服务器",
  ...
  "error.chain.checkConfig": "请检查你的配置 (cyberstrike.json) 中的 provider/model 名称",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 CyberStrike 服务器。",
  ...
  "settings.updates.row.startup.description": "在 CyberStrike 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 CyberStrike。",
