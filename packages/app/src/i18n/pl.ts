export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.provider.llmtr.note": "Modele hostowane w Turcji i niższe ceny modeli globalnych",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (cyberstrike.json) nazwy dostawców/modeli",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CyberStrike",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CyberStrike.",
