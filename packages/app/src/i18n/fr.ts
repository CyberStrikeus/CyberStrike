export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  ...
  "dialog.provider.llmtr.note": "Modèles hébergés en Türkiye et tarifs réduits sur les modèles mondiaux",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (cyberstrike.json) pour les noms de fournisseur/modèle",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur CyberStrike dans WSL sur Windows.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'CyberStrike",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'CyberStrike.",
