export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  ...
  "error.chain.checkConfig": "config (cyberstrike.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed":
    'MCPサーバー "{{name}}" が失敗しました。注意: CyberStrikeはまだMCP認証をサポートしていません。',
  ...
  "settings.desktop.wsl.description": "Windows上のWSL内でCyberStrikeサーバーを実行します。",
  ...
  "settings.updates.row.startup.description": "CyberStrike の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "CyberStrike は最新バージョンです。",
