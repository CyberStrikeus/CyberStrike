...
export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  ...
  "dialog.provider.llmtr.note": "Modeller driftet i Tyrkia og rabatterte priser på globale modeller",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (cyberstrike.json)",
  ...
  "settings.desktop.wsl.description": "Kjør CyberStrike-serveren i WSL på Windows.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CyberStrike starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CyberStrike.",
