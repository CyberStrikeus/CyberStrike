export const dict = {
  ...
  "dialog.provider.cyberstrike.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  ...
  "dialog.provider.llmtr.note": "Modelos alojados en Türkiye y precios con descuento en los globales",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (cyberstrike.json)",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor CyberStrike dentro de WSL en Windows.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CyberStrike",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CyberStrike.",
