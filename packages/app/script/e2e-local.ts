...
const keepSandbox = process.env.CYBERSTRIKE_E2E_KEEP_SANDBOX === "1"

const serverEnv = {
  ...process.env,
  CYBERSTRIKE_DISABLE_SHARE: process.env.CYBERSTRIKE_DISABLE_SHARE ?? "true",
...
try {
  ...
  if (seedExit !== 0) {
    ...
    inst = await import("../../cyberstrike/src/project/instance")
